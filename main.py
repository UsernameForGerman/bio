...
#parents = np.array([list([randint(0, 1) for k in range(10)] for j in range(2)) for parent in range(30)]) - number of individuals to gebv plot
...
breed = Breed(parents, possibilites, population_of_progeny=20, selection="gebv", max_age=1, max_population=10000000000,
