...
class Breed:
    ...
    def get_child_generation(self, parent_generation: Generation):
        ...
        generation_genotypes = children + parent_generation.genotypes
        return Generation(
            index=parent_generation.index + 1, genotypes=generation_genotypes, population=len(generation_genotypes)
        )
